...
class FactoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factory" do
    assert_difference('Factory.count') do
      post factories_url, params: { factory: { location: @factory.location, name: @factory.name } }
    end
  ...
  test "should update factory" do
    patch factory_url(@factory), params: { factory: { location: @factory.location, name: @factory.name } }
